...
//TokenType Enum
pub const TokenType = enum { Illegal, Eof, Ident, Int, Assign, Plus, Comma, SemiColon, Gt, Lt, Minus, Slash, Star, Lapren, Rparen, Lbrace, Rbrace, Bang, Function, Let, False, True, Return, If, Else, EqEq, BangEqual, String };

//Converts TokenType to String Literal Ease for displaying
